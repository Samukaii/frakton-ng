...
const meta: Meta = {
	...
	argTypes: {
		options: {
			...
			defaultValue: "[]",
			description: "Array of tag options to display in the selector"
		},
		value: {
			control: 'text',
			category: "Attributes",
			...
			description: "Currently selected tag ID with two-way binding"
		}
	}
}

export const Preview: Story<FktTagSelectorComponent<string>> = {
...
export const ProjectStatus: Story<FktTagSelectorComponent<string>> = {
...
export const UserStatus: Story<FktTagSelectorComponent<string>> = {
...
export const TeamAssignment: Story<FktTagSelectorComponent<string>> = {
...
export const Category: Story<FktTagSelectorComponent<string>> = {
