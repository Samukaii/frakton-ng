	...
	},
	{
		...
		stories: [
		    ...
		    },
		    {
		        ...
		        description:  `Popover content is just Angular template content, so compact forms can live inside the panel\nwithout a special API.`,
		        level: 3,
		    },
		    {
		        id: "positioning",
		        ...
		        type: "introduction",
		        componentName: null,
		        description:  `Configure where the panel appears relative to the trigger and how it reacts when the requested\nplacement does not fit.`,
		        level: 2,
		    },
		    {
		        id: "positions",
		    ...
		    },
		    {
		        ...
		        name: "TriggerRelativeSizing",
		        type: "story",
		        componentName: "PopoverTriggerWidthExampleComponent",
		        description:  `Use \`--fkt-popover-trigger-width\` with panel sizing tokens when the panel should derive its\nwidth from the trigger. This keeps sizing in CSS instead of adding one-off width inputs.`,
		        level: 3,
		    },
		    {
		        id: "dismiss-behavior",
