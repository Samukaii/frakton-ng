...
export const STORIES_MAP: StoryIndexer[] = [	{
	...
	},
	{
		...
		stories: [
		    ...
		    },
		    {
		        ...
		        type: "introduction",
		        componentName: null,
		        description:  `Appearance combines visual treatment, shape, color, and size without changing button semantics. Semantic\ncolors follow the design system, while custom CSS colors compute a contrasting content color.`,
		        level: 2,
		    },
		    {
		        id: "text-variants",
	...
	},
	{
		...
		docSections: [
			{ id: "api-reference", text: "API Reference", level: 2 },
			{ id: "native-surface", text: "Native surface", level: 2 },
			{ id: "structure-constraints", text: "Structure constraints", level: 2 },
			{ id: "semantics", text: "Semantics", level: 2 },
			{ id: "common-accessibility-patterns", text: "Common accessibility patterns", level: 3 },
			{ id: "trigger-behavior", text: "Trigger behavior", level: 2 },
			{ id: "dismiss-behavior", text: "Dismiss behavior", level: 2 },
			{ id: "restoring-trigger-focus", text: "Restoring trigger focus", level: 2 },
			{ id: "positioning", text: "Positioning", level: 2 },
			{ id: "position-update-lifecycle", text: "Position update lifecycle", level: 2 },
			{ id: "content-lifecycle", text: "Content lifecycle", level: 2 },
			{ id: "sizing-and-styling", text: "Sizing and styling", level: 2 },
			{ id: "animations", text: "Animations", level: 2 },
			{ id: "methods", text: "Methods", level: 2 },
			{ id: "public-types", text: "Public types", level: 2 }
		],
		stories: [
		    {
		        id: "usage",
		    ...
		    },
		    {
		        ...
		        type: "introduction",
		        componentName: null,
		        description:  `Configure where the panel appears relative to its anchor and how it reacts when the requested\nplacement does not fit.`,
		        level: 2,
		    },
		    {
		        id: "positions",
		        ...
		        description:  `Positions describe where the panel sits around the anchor. \`top\` and \`bottom\` are block sides;\n\`start\` and \`end\` are inline sides. Corner positions use the \`*-corner\` suffix.`,
		        level: 3,
		    },
		    {
		        id: "rtl-positioning",
		    ...
		    },
		    {
		        ...
		        name: "ExplicitAnchor",
		        type: "story",
		        componentName: "PopoverAnchorExampleComponent",
		        description:  `The trigger owns interaction and focus restoration. Bind its \`anchor\` input when positioning\nshould use a different \`HTMLElement\`; the anchor contributes geometry only and carries no widget\nsemantics. Without an explicit anchor, the trigger itself supplies both responsibilities.`,
		        level: 3,
		    },
		    {
		        id: "anchor-relative-sizing",
		        name: "AnchorRelativeSizing",
		        type: "story",
		        componentName: "PopoverAnchorWidthExampleComponent",
		        description:  `Use \`--fkt-popover-anchor-width\` with panel sizing tokens when the panel should derive its\nwidth from the resolved anchor. Without an explicit anchor, the trigger is used automatically.`,
		        level: 3,
		    },
		    {
		        id: "reposition",
		    ...
		    },
		    {
		        ...
		        type: "introduction",
		        componentName: null,
		        description:  `Bind \`[(open)]\` when a parent component should observe or change the popover state directly.`,
		        level: 2,
		    },
		    {
		    ...
		    },
		    {
		        ...
		        type: "introduction",
		        componentName: null,
		        description:  `Customize the panel surface and motion with CSS tokens and native popover animation selectors.`,
		        level: 2,
		    },
		    {
		        id: "design-tokens",
		        name: "DesignTokens",
		        type: "story",
		        componentName: "PopoverTokensExampleComponent",
		        description:  `The panel has a light default appearance and exposes styling hooks through CSS tokens instead of\nTypeScript style props.`,
		        level: 3,
		    },
		    {
		        id: "animations",
