	...
	},
	{
		...
		stories: [
		    ...
		    },
		    {
		        ...
		        description:  `Basic native input. The field renders the label and outline while \`input[fktInput]\` remains the\nreal form control, so native attributes and browser behavior stay available to the consumer.`,
		        level: 3,
		    },
		    {
		        id: "prefix-suffix",
		    ...
		    },
		    {
		        ...
		        name: "Textarea",
		        type: "story",
		        componentName: "FieldTextareaExampleComponent",
		        description:  `Textareas use the same \`fktInput\` directive and field shell as regular inputs.\nThe textarea remains native, so resizing, rows, maxlength, and external directives can be applied\ndirectly by the consumer.`,
		        level: 3,
		    },
		    {
		        id: "forms",
