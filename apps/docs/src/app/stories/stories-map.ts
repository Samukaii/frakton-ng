	...
	},
	{
		...
		stories: [
		    ...
		    },
		    {
		        ...
		        description:  `Lazy search can be triggered from \`isDropdownOpenedChange\`. This is useful when the first request\nshould happen only after the user opens the autocomplete instead of during initial page render.`,
		        level: 3,
		    },
		    {
		    ...
		    },
		    {
		        ...
		        name: "ControlledDropdown",
		        type: "story",
		        componentName: "AutocompleteControlledDropdownExampleComponent",
		        description:  `Overlay state can be controlled with \`isDropdownOpened\`. This is mostly useful for guided flows,\nexternal triggers, or advanced UI coordination.`,
		        level: 3,
		    },
		    {
		        id: "data-loading",
