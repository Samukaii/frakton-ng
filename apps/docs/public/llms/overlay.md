...
import {FktSimpleOverlayDialogComponent} from '../dialog/fkt-simple-overlay-dialog/fkt-simple-overlay-dialog.component';
...
export class FktSimpleOverlayExampleComponent {
    ...
    messageSignal = signal(
        'This overlay is positioned relative to the button!'
    );
        ...
        const overlayRef = this.overlayService.open({
            ...
            data: {
                ...
                formSubmit: (formData: FormData) => {
                    ...
                    alert(
                        `Thank you ${formData.name}! We received your message and will get back to you soon.`
                    );
                    overlayRef.close();
                },
                cancel: () => {
...
export class FktCustomTooltipOverlayExampleComponent {
    ...
    private overlayRef: FktOverlayRef<FktTooltipOverlayDialogComponent> | null =
        null;
...
<div class="container">
    <div #infoButton>
        <button
                (click)="openTooltip(infoButton, 'info', 'This is an informational tooltip message.', 'top-start')"
                color="primary"
                fktButton
                label="Info Tooltip">
        </button>
    ...
    <div #warningButton>
        <button
                (click)="openTooltip(warningButton, 'warning', 'This is a warning tooltip message.', 'top-start')"
                color="accent"
                fktButton
    ...
    <div #errorButton>
        <button
                (click)="openTooltip(errorButton, 'danger', 'This is an error tooltip message.', 'bottom-start')"
                color="danger"
                fktButton
                label="Error Tooltip">
        </button>
    ...
    <div #successButton>
        <button
                (click)="openTooltip(successButton, 'success', 'This is a success tooltip message.', 'bottom-start')"
                color="success"
                fktButton
...
<div #ref class="actions">
    ...
    <button
            (click)="openCounterOverlay(ref)"
            color="primary"
            fktButton
            label="Counter Overlay">
    </button>
</div>
```
