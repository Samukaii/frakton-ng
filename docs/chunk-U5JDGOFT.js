...
`;var K={title:"Components/Form/Date Picker",description:"The FktDatePicker component provides an intuitive and accessible date selection interface. Built with Angular signals and reactive forms, it offers a clean input field with a calendar overlay for date selection.",component:c,documentation:L,argTypes:{label:{control:"text",category:"Attributes",type:"string",defaultValue:"undefined",description:"Label text displayed above the input field"},placeholder:{control:"text",category:"Attributes",type:"string",defaultValue:"undefined",description:"Placeholder text shown in the input field"}}},me={description:"A basic date picker with label and placeholder. Click the input field to open the calendar modal for date selection.",args:{label:"Birth Date",placeholder:"Select your birth date"}},fe={description:"A date picker initialized with today's date, showing how the component displays pre-selected values.",args:{label:"Event Date",placeholder:"Select event date"}},ge={description:"A date picker with required field validation. The field shows error state when empty and must be filled for form submission.",args:{label:"Due Date (Required)",placeholder:"Please select a due date"}},he={description:"A date picker in disabled state. The field shows a date value but cannot be modified by the user.",args:{label:"Fixed Date",placeholder:"This date cannot be changed"}},ke={description:"A date picker with a format hint in the placeholder to guide users on the expected date format.",args:{label:"Start Date",placeholder:"DD/MM/YYYY format"}},ve=K;export{me as BasicDatePicker,he as DisabledState,ge as RequiredValidation,ke as WithFormatHint,fe as WithPrefilledDate,ve as default};
