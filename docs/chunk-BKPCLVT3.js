import"./chunk-A25UGBQK.js";var t=`<fkt-table
    [data]="data()"
    [columnsFn]="columnsFn"
    [loading]="loading()"
...
\r
`;var s=`import { Component, computed, input, signal } from '@angular/core';
...
`;var d=`import { Component, input, linkedSignal, signal } from '@angular/core';\r
...
/>
`;var g=`:host ::ng-deep {
	.table-product-no-stock {
		background-color: var(--fkt-color-danger-opacity-10);
	...
	.table-product-discontinued {
		...
		&:hover {
			background-color: var(--fkt-color-neutral-100) !important;
		}
	}
}
...
`;var f=`import { Component, input } from '@angular/core';
import { FktTableActionFn, FktTableClassesFn, FktTableColumnFn, FktTableComponent } from 'frakton-ng/table';
import { FktButtonAction } from 'frakton-ng/button';
import { FktNoResults } from 'frakton-ng/no-results';
...
@Component({
	...
	templateUrl: './fkt-table-examples-product-table.component.html',
