...
<Story of={fktOverlayStories.SimpleOverlay} />
...
<Story of={fktOverlayStories.TooltipOverlay} />
...
export class FktCustomTooltipOverlayExampleComponent {
	...
	openTooltip(
		...
		text: string,
		position: FktGeometryPosition = 'top-start'
	) {
...
<Story of={fktOverlayStories.DropdownMenuOverlay} />
...
@Component({
	...
	template: `
		<div class="p-6 space-y-4">
			<h3 class="text-lg font-semibold">Dropdown Menu Overlays</h3>
			<p class="text-gray-600">Action menus and option selectors with different configurations.</p>

			<div class="grid grid-cols-2 gap-4">
				<div>
					<h4 class="font-medium mb-2">File Actions</h4>
				...
				<div>
					<h4 class="font-medium mb-2">Admin Actions</h4>
					<div #adminButton>
						<fkt-button
							text="Admin Actions ↓"
							theme="stroked"
...
<Story of={fktOverlayStories.FormOverlay} />
...
@Component({
	...
	`,
	standalone: true,
	imports: [FktButtonComponent, FktInputComponent, FktIconComponent]
})
export class FktFormOverlayDemoComponent implements OnInit {
	...
	nameControl = new SignalFormControl('');
	emailControl = new SignalFormControl('');
	messageControl = new SignalFormControl('');

	ngOnInit() {
		this.nameControl.setValue(this.initialName());
		this.emailControl.setValue(this.initialEmail());
		this.messageControl.setValue(this.initialMessage());
	}

	isFormValid = signal(true); // Simple validation for demo
	...
	openSettingsForm(nativeElement: HTMLElement) {
		const overlayRef = this.overlayService.open({
			...
			data: {
				...
				initialEmail: 'jane.smith@company.com',
				initialMessage: 'Full-stack developer with 5+ years of experience.',
				onFormSubmit: (formData: FormData) => {
...
<Story of={fktOverlayStories.InteractiveOverlay} />
					...
					<div class="max-h-32 overflow-y-auto space-y-1">
						@for(item of currentItems(); track $index) {
							<div class="flex items-center justify-between bg-white px-3 py-2 rounded border">
								...
								>
									<fkt-icon name="x-mark" size="14"></fkt-icon>
								</button>
							</div>
						}
					</div>
...
@Component({
	...
	template: `
		<div class="p-6 space-y-4">
			<h3 class="text-lg font-semibold">Interactive Overlays</h3>
			<p class="text-gray-600">Advanced overlays with reactive content and bidirectional data binding.</p>
...
export class FktInteractiveOverlayExampleComponent {
	...
	resetAll() {
		...
		console.log('All shared state reset');
	}
}
```
