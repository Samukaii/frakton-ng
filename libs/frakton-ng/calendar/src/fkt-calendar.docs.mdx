...
<StoryDoc of={fktCalendarStories.Basic} code={rawExamples.fktCalendarBasicExample}/>

<StoryDoc of={fktCalendarStories.BorderlessMode} code={rawExamples.fktCalendarBorderlessExample}/>

<StoryDoc of={fktCalendarStories.CustomDateStyling} code={rawExamples.fktCalendarCustomExample}/>

<StoryDoc of={fktCalendarStories.EventsAndCallbacks} code={rawExamples.fktCalendarEventsExample}/>

<StoryDoc of={fktCalendarStories.DisabledDates} code={rawExamples.fktCalendarDisabledExample}/>
