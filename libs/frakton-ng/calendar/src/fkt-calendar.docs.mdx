...
import * as fktCalendarStories from './fkt-calendar.stories';
...
<FktStoryRenderer of={fktCalendarStories.Basic} code={rawExamples.fktCalendarBasicExample}/>

<FktStoryRenderer of={fktCalendarStories.BorderlessMode} code={rawExamples.fktCalendarBorderlessExample}/>

<FktStoryRenderer of={fktCalendarStories.CustomDateStyling} code={rawExamples.fktCalendarCustomExample}/>

<FktStoryRenderer of={fktCalendarStories.EventsAndCallbacks} code={rawExamples.fktCalendarEventsExample}/>

<FktStoryRenderer of={fktCalendarStories.DisabledDates} code={rawExamples.fktCalendarDisabledExample}/>
