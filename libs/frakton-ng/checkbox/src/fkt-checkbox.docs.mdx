...
<StoryDoc of={fktCheckboxStories.BasicCheckbox} code={rawExamples.fktCheckboxBasicExample}/>
<StoryDoc of={fktCheckboxStories.PreCheckedCheckbox} code={rawExamples.fktCheckboxPreCheckedExample}/>
<StoryDoc of={fktCheckboxStories.DisabledState} code={rawExamples.fktCheckboxDisabledExample}/>
<StoryDoc of={fktCheckboxStories.Validation} code={rawExamples.fktCheckboxValidationExample}/>
