...
<FktStoryRenderer of={fktCheckboxStories.BasicCheckbox} code={rawExamples.fktCheckboxBasicExample}/>
<FktStoryRenderer of={fktCheckboxStories.PreCheckedCheckbox} code={rawExamples.fktCheckboxPreCheckedExample}/>
<FktStoryRenderer of={fktCheckboxStories.DisabledState} code={rawExamples.fktCheckboxDisabledExample}/>
<FktStoryRenderer of={fktCheckboxStories.Validation} code={rawExamples.fktCheckboxValidationExample}/>
