...
@Component({
	...
	templateUrl: './fkt-textarea-old.component.html',
	styleUrl: './fkt-textarea-old.component.scss',
	changeDetection: ChangeDetectionStrategy.OnPush,
	host: {
		'[class.disabled]': 'disabled()'
	}
})
export class FktTextareaOldComponent implements AfterViewInit, FormValueControl<string | null> {
