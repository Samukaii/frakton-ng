...
<FktStoryRenderer of={stories.BasicSelect} code={rawExamples.defaultExample}/>
<FktStoryRenderer of={stories.PreSelectedOption} code={rawExamples.preselectedExample}/>
<FktStoryRenderer of={stories.LargeOptionsList} code={rawExamples.largeListExample}/>
<FktStoryRenderer of={stories.LoadingState} code={rawExamples.loadingExample}/>
<FktStoryRenderer of={stories.EmptyState} code={rawExamples.emptyStateExample}/>
<FktStoryRenderer of={stories.WithValidation} code={rawExamples.validationExample}/>
<FktStoryRenderer of={stories.DisabledState} code={rawExamples.disabledExample}/>
<FktStoryRenderer of={stories.AsyncLoading} code={rawExamples.asyncLoading}/>
