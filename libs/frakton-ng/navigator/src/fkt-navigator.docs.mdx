...
<StoryDoc of={fktNavigatorStories.BasicNavigator} code={rawExamples.basicExample}/>
<StoryDoc of={fktNavigatorStories.PageNavigation} code={rawExamples.pageNavigationExample}/>
<StoryDoc of={fktNavigatorStories.DateNavigation} code={rawExamples.dateNavigationExample}/>
<StoryDoc of={fktNavigatorStories.ItemListNavigation} code={rawExamples.itemNavigationExample}/>
<StoryDoc of={fktNavigatorStories.DisabledStates} code={rawExamples.disabledStateExample}/>
<StoryDoc of={fktNavigatorStories.WithLoadingState} code={rawExamples.loadingExample}/>
