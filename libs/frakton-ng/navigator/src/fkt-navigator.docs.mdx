...
<FktStoryRenderer of={fktNavigatorStories.BasicNavigator} code={rawExamples.basicExample}/>
<FktStoryRenderer of={fktNavigatorStories.PageNavigation} code={rawExamples.pageNavigationExample}/>
<FktStoryRenderer of={fktNavigatorStories.DateNavigation} code={rawExamples.dateNavigationExample}/>
<FktStoryRenderer of={fktNavigatorStories.ItemListNavigation} code={rawExamples.itemNavigationExample}/>
<FktStoryRenderer of={fktNavigatorStories.DisabledStates} code={rawExamples.disabledStateExample}/>
<FktStoryRenderer of={fktNavigatorStories.WithLoadingState} code={rawExamples.loadingExample}/>
