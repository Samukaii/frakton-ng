...
<FktStoryRenderer of={stories.BasicTable} code={rawExamples.fktTableExamplesBasicTable}/>
<FktStoryRenderer of={stories.TableWithActions} code={rawExamples.fktTableExamplesTableWithActions}/>
<FktStoryRenderer of={stories.LoadingState} code={rawExamples.fktTableExamplesLoadingState}/>
<FktStoryRenderer of={stories.EmptyState} code={rawExamples.fktTableExamplesEmptyState}/>
<FktStoryRenderer of={stories.InteractiveStates} code={rawExamples.fktTableExamplesInteractiveStates}/>
<FktStoryRenderer of={stories.CustomCellTypes} code={rawExamples.fktTableExamplesCustomCells}/>
<FktStoryRenderer of={stories.ProductTable} code={rawExamples.fktTableExamplesProductTable}/>
<FktStoryRenderer of={stories.TaskTable} code={rawExamples.fktTableExamplesTaskTable}/>
