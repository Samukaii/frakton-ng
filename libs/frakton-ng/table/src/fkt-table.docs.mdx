...
<StoryDoc of={stories.BasicTable} code={rawExamples.fktTableExamplesBasicTable}/>
<StoryDoc of={stories.TableWithActions} code={rawExamples.fktTableExamplesTableWithActions}/>
<StoryDoc of={stories.LoadingState} code={rawExamples.fktTableExamplesLoadingState}/>
<StoryDoc of={stories.EmptyState} code={rawExamples.fktTableExamplesEmptyState}/>
<StoryDoc of={stories.InteractiveStates} code={rawExamples.fktTableExamplesInteractiveStates}/>
<StoryDoc of={stories.CustomCellTypes} code={rawExamples.fktTableExamplesCustomCells}/>
<StoryDoc of={stories.ProductTable} code={rawExamples.fktTableExamplesProductTable}/>
<StoryDoc of={stories.TaskTable} code={rawExamples.fktTableExamplesTaskTable}/>
