...
import { FktInputTransformer, FktInputType, fktInputOldTypes } from './fkt-input-old.types';
 ...
 * @deprecated Use <fkt-field> + fktInputText
 */
@Component({
	selector: 'fkt-input',
	imports: [
	...
	templateUrl: './fkt-input-old.component.html',
	styleUrl: './fkt-input-old.component.scss',
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FktInputOldComponent<T=string> implements FormValueControl<T | null> {
	...
	type = input<FktInputType, FktInputType>('text', {
		transform: (value: FktInputType) => {
			if (fktInputOldTypes.includes(value)) return value;
