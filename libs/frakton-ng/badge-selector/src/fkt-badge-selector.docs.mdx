...
<FktStoryRenderer of={fktBadgeSelectorStories.Preview}/>
<FktStoryRenderer of={fktBadgeSelectorStories.OrderStatus} code={rawExamples.orderStatusExample}/>
<FktStoryRenderer of={fktBadgeSelectorStories.Priority} code={rawExamples.priorityExample}/>
<FktStoryRenderer of={fktBadgeSelectorStories.ProjectStatus}/>
<FktStoryRenderer of={fktBadgeSelectorStories.UserStatus}/>
<FktStoryRenderer of={fktBadgeSelectorStories.TeamAssignment}/>
<FktStoryRenderer of={fktBadgeSelectorStories.Category}/>
