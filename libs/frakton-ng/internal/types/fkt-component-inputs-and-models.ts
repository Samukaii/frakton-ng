...
import { FktComponentInputsAndModelNames } from './fkt-component-inputs-and-model-names';


type ComponentInput<T> = {
	[Key in FktComponentInputsAndModelNames<T>]: T[Key] extends InputSignal<
		infer InputValue
	>
		? InputValue
		: never;
...
export type FktComponentInputsAndModels<T> = RequiredComponentInputs<T> &
