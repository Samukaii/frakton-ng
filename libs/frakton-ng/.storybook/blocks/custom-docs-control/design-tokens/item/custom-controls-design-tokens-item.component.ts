...
@Component({
	selector: 'fkt-custom-controls-design-tokens-item',
	imports: [
		FktButtonComponent,
		FktInputComponent,
		FktTooltipDirective,
	...
	templateUrl: './custom-controls-design-tokens-item.component.html',
	styleUrl: './custom-controls-design-tokens-item.component.scss'
})
export class CustomControlsDesignTokensItemComponent {
