...
import { CustomControlsDesignTokensItemComponent } from './item/custom-controls-design-tokens-item.component';
import { FktIconComponent, FktIconName } from 'frakton-ng/icon';

@Component({
	selector: 'fkt-custom-controls-design-tokens',
	imports: [
		FktButtonComponent,
		FktTooltipDirective,
		CustomControlsDesignTokensItemComponent,
		FktIconComponent
	],
	templateUrl: './custom-controls-design-tokens.component.html',
	styleUrl: './custom-controls-design-tokens.component.scss',
	host: {
		'[class.expanded]': 'expanded()'
	}
})
export class CustomControlsDesignTokensComponent {
	expanded = input(true);
