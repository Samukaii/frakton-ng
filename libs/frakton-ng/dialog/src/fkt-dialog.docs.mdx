...
import {FktCode} from "../../.storybook/blocks/mdx/FktCode/FktCode";
...
<FktStoryRenderer of={fktDialogStories.SimpleDialog} code={[
	rawExamples.fktSimpleDialogExample,
	rawExamples.fktSimpleDialogDemo
]}/>
<FktStoryRenderer of={fktDialogStories.FormDialog} code={[
	rawExamples.fktFormDialogExample,
	rawExamples.fktFormDialogDemo
]}/>
<FktStoryRenderer of={fktDialogStories.CustomDialog} code={[
	rawExamples.fktCustomDialogExample,
	rawExamples.fktCustomDialogDemo
]}/>
<FktStoryRenderer of={fktDialogStories.ConfirmationDialog} code={[
	rawExamples.fktConfirmationDialogExample,
]}/>
<FktStoryRenderer of={fktDialogStories.FullScreenDialog} code={[
	rawExamples.fktFullscreenDialogExample,
	rawExamples.fktFullscreenDialogExample
]}/>
<FktStoryRenderer of={fktDialogStories.SmallDialog} code={[
	rawExamples.fktSmallDialogExample,
	rawExamples.fktSimpleDialogDemo
]}/>
