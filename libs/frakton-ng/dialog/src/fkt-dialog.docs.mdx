...
<StoryDoc of={fktDialogStories.SimpleDialog} code={[
	rawExamples.fktSimpleDialogExample,
	rawExamples.fktSimpleDialogDemo
]}/>
<StoryDoc of={fktDialogStories.FormDialog} code={[
	rawExamples.fktFormDialogExample,
	rawExamples.fktFormDialogDemo
]}/>
<StoryDoc of={fktDialogStories.CustomDialog} code={[
	rawExamples.fktCustomDialogExample,
	rawExamples.fktCustomDialogDemo
]}/>
<StoryDoc of={fktDialogStories.ConfirmationDialog} code={[
	rawExamples.fktConfirmationDialogExample,
]}/>
<StoryDoc of={fktDialogStories.FullScreenDialog} code={[
	rawExamples.fktFullscreenDialogExample,
	rawExamples.fktFullscreenDialogExample
]}/>
<StoryDoc of={fktDialogStories.SmallDialog} code={[
