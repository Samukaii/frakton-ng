...
<FktStoryRenderer of={stories.BasicSideMenu} fixedSize={true} code={rawExamples.basicSideMenuExample}/>
<FktStoryRenderer of={stories.CollapsibleSideMenu} fixedSize={true} code={rawExamples.collapsibleSideMenuExample}/>
<FktStoryRenderer of={stories.MultiGroupNavigation} fixedSize={true} code={rawExamples.multiGroupSideMenuExample}/>
<FktStoryRenderer of={stories.DynamicMenuWithPermissions} fixedSize={true} code={rawExamples.dynamicPermissionsSideMenuExample}/>
<FktStoryRenderer of={stories.AdminDashboardLayout} fixedSize={true} code={rawExamples.adminDashboardLayoutExample}/>
<FktStoryRenderer of={stories.WithRouting} fixedSize={true} code={[
	rawExamples.withRoutingExample,
	rawExamples.adminDashboardPage,
	rawExamples.adminUsersPage,
	rawExamples.adminSettingsPage,
]}/>
