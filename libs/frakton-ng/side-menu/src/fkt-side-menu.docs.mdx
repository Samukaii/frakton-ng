...
<StoryDoc of={stories.BasicSideMenu} fixedSize={true} code={rawExamples.basicSideMenuExample}/>
<StoryDoc of={stories.CollapsibleSideMenu} fixedSize={true} code={rawExamples.collapsibleSideMenuExample}/>
<StoryDoc of={stories.MultiGroupNavigation} fixedSize={true} code={rawExamples.multiGroupSideMenuExample}/>
<StoryDoc of={stories.DynamicMenuWithPermissions} fixedSize={true} code={rawExamples.dynamicPermissionsSideMenuExample}/>
<StoryDoc of={stories.AdminDashboardLayout} fixedSize={true} code={rawExamples.adminDashboardLayoutExample}/>
<StoryDoc of={stories.WithRouting} fixedSize={true} code={[
