...
import { FktAutoCompleteAddOptionEvent, FktAutocompleteOption } from './fkt-autocomplete-old.types';
...
@Component({
	...
	templateUrl: './fkt-autocomplete-old.component.html',
	styleUrl: './fkt-autocomplete-old.component.scss',
	imports: [
...
export class FktAutocompleteOldComponent implements FormValueControl<string | number | null> {
	...
	private inputComponent = viewChild.required(FktInputOldComponent, {read: ElementRef});
