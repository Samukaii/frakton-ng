...
<FktStoryRenderer of={fktOverlayStories.SimpleOverlay} code={[
	rawExamples.fktSimpleOverlayExample,
	rawExamples.fktSimpleOverlayDialog
]}/>
<FktStoryRenderer of={fktOverlayStories.CustomTooltipOverlay} code={[
	rawExamples.fktCustomTooltipOverlayExample,
	rawExamples.fktTooltipOverlayDialog
]}/>
<FktStoryRenderer of={fktOverlayStories.DropdownMenuOverlay} code={[
	rawExamples.fktDropdownOverlayExample,
	rawExamples.fktDropdownOverlayDialog
]}/>
<FktStoryRenderer of={fktOverlayStories.FormOverlay} code={[
	rawExamples.fktFormOverlayExample,
	rawExamples.fktFormOverlayDialog,
]}/>
<FktStoryRenderer of={fktOverlayStories.InteractiveOverlay} code={[
	rawExamples.fktInteractiveOverlayExample,
	rawExamples.fktInteractiveOverlayDialog
]}/>
...
```typescript
interface FktOverlayPanelOptions {
	panelOptions: {
