...
<FktStoryRenderer of={fktAutocompleteStories.Basic} code={rawExamples.fktAutocompleteBasicExample}/>

<FktStoryRenderer of={fktAutocompleteStories.AutoCreation} code={rawExamples.fktAutocompleteAutoCreationExample}/>

<FktStoryRenderer of={fktAutocompleteStories.CustomStyling} code={rawExamples.fktAutocompleteCustomStylingExample}/>

<FktStoryRenderer of={fktAutocompleteStories.Events} code={rawExamples.fktAutocompleteEventsExample}/>

<FktStoryRenderer of={fktAutocompleteStories.LoadingStates} code={rawExamples.fktAutocompleteLoadingStatesExample}/>
