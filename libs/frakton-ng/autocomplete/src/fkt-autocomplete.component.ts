...
import { FktAutocompleteEmptyDirective } from './directives/public/fkt-autocomplete-empty.directive';
import { FktAutocompleteFooterDirective } from './directives/public/fkt-autocomplete-footer.directive';
import { FktAutocompleteGroupDirective } from './directives/public/fkt-autocomplete-group.directive';
import { FktAutocompleteHeaderDirective } from './directives/public/fkt-autocomplete-header.directive';
import { FktAutocompleteItemDirective } from './directives/public/fkt-autocomplete-item.directive';
import {
...
@Component({
  ...
  imports: [
    ...
    FktFieldSuffixDirective,
    FktPopoverComponent,
    FktAutocompleteOptionsComponent,
    FktPopoverTriggerDirective,
    FktPopoverContentDirective,
  ],
  ...
  implements ControlValueAccessor, AfterViewInit
{
  ...
  protected readonly chipDirective = contentChild(FktAutocompleteChipDirective);

  protected readonly itemTemplate = contentChild(FktAutocompleteItemDirective);
  ...
  protected readonly footerTemplate = contentChild(
    FktAutocompleteFooterDirective
  );
  protected readonly emptyTemplate = contentChild(
  ...
  protected onSelect(option: FktAutocompleteOption<Option>) {
